...
public final class SettingsConf {
	...
	public enum Bool implements Storable {
	...
	public enum Int implements Storable {
	...
	public enum Str implements Storable {
	...
	public enum IntArray implements Storable {
	...
	public enum StrList implements Storable {
		SearchHistory,
		;
	...
	@Description("# Window dimensions: x, y, width and height. If x < 0 or" +
			...
			"\r\n# its parent window.")
	public enum ShellBounds implements Storable {
	...
	public enum ColumnWidths implements Storable {
	...
	public enum ColumnOrder implements Storable {
	...
	public enum SashWeights implements Storable {
		ProgressPanel (2, 1),
		;
	...
	public enum FontDescription implements Storable {
		/*
		 * Note: The font choices below prioritize broad Unicode support,
		 * including Vietnamese. CJK languages use OS-level font fallback as
		 * these fonts don't include full CJK glyph sets.
		 */
		PreviewWindows ("Segoe UI", 11, SWT.NORMAL),
		PreviewLinux ("DejaVu Sans", 11, SWT.NORMAL),
		PreviewMacOsX ("SF Pro Text", 13, SWT.NORMAL),
		PreviewMonoWindows ("Consolas", 12, SWT.NORMAL),
		PreviewMonoLinux ("Liberation Mono", 12, SWT.NORMAL),
		PreviewMonoMacOsX ("Menlo", 12, SWT.NORMAL),
		;
	...
	public static String loadHeaderComment() throws IOException {
		...
		try {
			...
			// Fallback for corrupted/incompatible Guava library (e.g., ClassFormatError)
			// Use standard Java API instead
